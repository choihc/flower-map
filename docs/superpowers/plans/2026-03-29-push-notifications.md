...
| `apps/admin/src/lib/notifications/easPushClient.ts` | EAS Push API 배치 발송 클라이언트 |
| `apps/admin/src/lib/notifications/easPushClient.test.ts` | easPushClient 단위 테스트 |
| `apps/admin/app/api/notifications/send/route.ts` | 발송 API Route |
| `apps/admin/app/(dashboard)/notifications/page.tsx` | 어드민 발송 UI 페이지 |
...
| `apps/admin/src/features/dashboard/AdminSidebar.tsx` | "알림 발송" 메뉴 항목 추가 |
| `apps/admin/src/features/dashboard/AdminSidebar.test.tsx` | 새 메뉴 항목 검증 추가 |
...
**Files:**
- Create: `apps/admin/src/lib/notifications/easPushClient.ts`
- Create: `apps/admin/src/lib/notifications/easPushClient.test.ts`

- [ ] **Step 1: 테스트 파일 작성 (실패 상태로)**

```ts
// apps/admin/src/lib/notifications/easPushClient.test.ts
...
```bash
cd apps/admin && pnpm test -- src/lib/notifications/easPushClient.test.ts
```
...
```ts
// apps/admin/src/lib/notifications/easPushClient.ts
...
```bash
git add apps/admin/src/lib/notifications/easPushClient.ts \
        apps/admin/src/lib/notifications/easPushClient.test.ts
...
**Files:**
- Create: `apps/admin/app/api/notifications/send/route.ts`
...
```ts
// apps/admin/app/api/notifications/send/route.ts
...
```bash
git add apps/admin/app/api/notifications/send/route.ts
...
**Files:**
- Create: `apps/admin/app/(dashboard)/notifications/page.tsx`
- Modify: `apps/admin/src/features/dashboard/AdminSidebar.tsx`
- Modify: `apps/admin/src/features/dashboard/AdminSidebar.test.tsx`
...
```bash
cd apps/admin && pnpm test -- src/features/dashboard/AdminSidebar.test.tsx
```
...
```bash
git add apps/admin/app/\(dashboard\)/notifications/page.tsx \
