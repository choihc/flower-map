  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] py-16 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        {/* 헤더 */}
        <div className="mb-10">
          <Link href="/" className="text-sm text-gray-400 hover:text-[#1A1A1A] transition-colors mb-4 inline-block">
            ← 꽃 어디
          </Link>
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 flex justify-center gap-6 text-sm text-gray-400">
          ...
          <Link href="/" className="hover:text-[#1A1A1A] transition-colors">앱 소개</Link>
        </div>
      </div>
    </div>
  );
