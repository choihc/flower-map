...
export const Card = React.forwardRef<HTMLDivElement, DivProps>(({ className, ...props }, ref) => {
  return <div ref={ref} className={cn('rounded-[28px] border border-border bg-card shadow-[0_12px_40px_rgba(15,23,42,0.04)]', className)} {...props} />;
});
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => {
    return <h3 ref={ref} className={cn('text-base font-semibold leading-none tracking-[-0.02em] text-foreground', className)} {...props} />;
  },
);
