...
const utilityNavItems = [{ href: '/settings', label: '설정' }];
    ...
    <aside className="min-w-0">
      <Card className="sticky top-5 flex min-h-[calc(100vh-40px)] flex-col p-4">
        ...
        <div className="mt-4 flex flex-1 flex-col gap-6">
          ...
          <nav aria-label="환경" className="mt-auto flex flex-col gap-1">
            <p className="px-3 text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">환경</p>
